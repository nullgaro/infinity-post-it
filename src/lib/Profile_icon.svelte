...
<template lang="pug">
    svg(width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 [&>*:nth-child(3)]:duration-150 [&>*:nth-child(3)]:hover:stroke-p-yellow")
